...
function calcularFormaspag(){
    ...
    // aplicando os 10% pagando a vsta
        if (avista.checked){
            ...
            resultado.value = "Desc: " +desconto+ ".  Pagar: "+valor;
        }
        if (parcelado2.checked) {
            parcelado2 = Number(valor) / 2;
            
            resultado.value = "Parcel: " +parcelado2+ ".  Pagar: "+valor;
        }
        if (parcelado3.checked) {
            parcelado3 = Number(valor) / 3;
            

            resultado.value = "Parcel: " +parcelado3+ ".  Pagar: "+valor;
        ...
        if (dividido.checked) {
            ...
            resultado.value = "Juros: " +juros+ ".  Pagar: "+valor;
